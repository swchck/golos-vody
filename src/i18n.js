...
export const STR = {
  ru: {
    ...
    variant_have: (n, m) => `собрано ${n} из ${m}`,
    variant_recommend: 'советуем',
    variant_rec_why: 'этой карты у тебя меньше всего — история поможет добить колоду',
  ...
  en: {
    ...
    variant_have: (n, m) => `${n} of ${m} collected`,
    variant_recommend: 'suggested',
    variant_rec_why: "you have the fewest of this card — telling it here helps complete that card's deck",
